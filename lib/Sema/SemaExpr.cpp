...
static bool CheckExtensionTraitOperandType(Sema &S, QualType T,
  ...
  // C99 6.5.3.4p1:
  if (T->isFunctionType() &&
      (TraitKind == UETT_SizeOf || TraitKind == UETT_AlignOf || TraitKind == UETT_PreferredAlignOf)) {
...
bool Sema::CheckUnaryExprOrTypeTraitOperand(Expr *E,
  ...
  if ((ExprKind == UETT_SizeOf || ExprKind == UETT_AlignOf || ExprKind == UETT_PreferredAlignOf) &&
